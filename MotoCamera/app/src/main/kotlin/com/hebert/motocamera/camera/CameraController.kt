...
class CameraController(private val context: Context) {
    ...
    suspend fun bindCamera(
        ...
        // WYSIWYG: apply punchy tone curve at sensor level so preview matches capture
        val camera2Preview = Camera2Interop.Extender(previewBuilder)
        applySensorToneCurve(camera2Preview)
    ...
    private fun applySensorToneCurve(extender: Camera2Interop.Extender<Preview.Builder>) {
        // S-curve for punchy, saturated look — matches final processed output
        ...
        } catch (_: Exception) { /* hardware may not support; falls back to AUTO */ }
    }
